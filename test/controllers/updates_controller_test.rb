...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { device_id: @update.device_id, ip_address: @update.ip_address } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { device_id: @update.device_id, ip_address: @update.ip_address } }
